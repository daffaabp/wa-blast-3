				...
				for (const recipient of recipients) {
					try {
						...
						if (recipient !== recipients[recipients.length - 1]) {
							// Cek apakah perlu delay khusus setiap 5, 30 atau 105 pesan
							const isPerFiveMessages = totalSent > 0 && totalSent % 5 === 0;
							const isPerThirtyMessages = totalSent > 0 && totalSent % 30 === 0;
							const isPerOneHundredFiveMessages =
								totalSent > 0 && totalSent % 105 === 0;
							let delayTime;
							...
							if (isPerOneHundredFiveMessages) {
								...
								console.log(
									`Menunggu ${(delayTime / 1000).toFixed(3)} detik setelah mengirim 105 pesan...`,
								);
								...
								console.log(
									`Menunggu ${(delayTime / 1000).toFixed(3)} detik setelah mengirim 30 pesan...`,
								);
